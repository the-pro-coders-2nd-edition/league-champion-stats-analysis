...
<style>
  ...
  .ctl--outlined:hover:not(:disabled) { color: var(--color-accent); border-color: var(--color-accent); filter: none; }
  ...
  .ctl--bare:hover:not(:disabled) { color: var(--color-accent); background: rgba(124, 108, 240, .08); filter: none; }
  .ctl--bare.ctl--sm {
    border: none;
    background: none;
    padding: 8px 4px;
