"""Transitional re-export shim -- real code now lives in `league_stats_runner.pipeline.game_review`.
...
import league_stats_runner.pipeline.game_review as _real_module
