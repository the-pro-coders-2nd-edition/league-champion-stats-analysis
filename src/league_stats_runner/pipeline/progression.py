...
from league_stats_runner.analysis.progression.export import progression_to_markdown
from league_stats_runner.analysis.progression.slicing import slice_baseline, slice_recent
from league_stats_common.core.config import (
    PROGRESSION_PRESETS_V1,
    AppConfig,
    QUEUE_FILTER_OPTIONS,
)
from league_stats_common.core.models import MatchRecord, ProgressionComparison
...
from league_stats_runner.pipeline.view_models import form_row_display, form_sample_subtitle
from league_stats_runner.presentation.graphs import GraphFactory
...
def _recommendation_payload(rec: Any) -> dict[str, Any]:
    from league_stats_runner.pipeline.bundles import _recommendation_payload as bundle_rec_payload
