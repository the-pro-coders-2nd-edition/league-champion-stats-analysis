...
from league_stats_runner.analysis.game_review.views import build_game_review_views as _build_payload
from league_stats_runner.analysis.game_review.views import game_review_to_template_context
